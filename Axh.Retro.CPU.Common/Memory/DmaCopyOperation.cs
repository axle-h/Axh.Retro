...
namespace Axh.Retro.CPU.Common.Memory
{
    ...
    public class DmaCopyOperation : IDmaOperation
    {
        ...
        public DmaCopyOperation(ushort sourceAddress, ushort destinationAddress, int length, InstructionTimings timings, IEnumerable<AddressRange> lockedAddressesRanges)
        {
