...
namespace Axh.Retro.CPU.Z80.Core.Interpreted
{
    public class InterpreterHelper
    {
        ...
        public byte Operand1
        {
            get
            {
                return ReadOperand(Operation.Operand1);
            }
            set
            {
                WriteOperand(value, Operation.Operand1);
            }
        }
        ...
        public byte Operand2
        {
            get
            {
                return ReadOperand(Operation.Operand2);
            }
            set
            {
                WriteOperand(value, Operation.Operand2);
            }
        }
        ...
        public ushort WordOperand1
        {
            get
            {
                return Read16BitOperand(Operation.Operand1);
            }
            set
            {
                Write16BitOperand(value, Operation.Operand1);
            }
        }
        ...
        public ushort WordOperand2
        {
            get
            {
                return Read16BitOperand(Operation.Operand2);
            }
            set
            {
                Write16BitOperand(value, Operation.Operand2);
            }
        }
        ...
        public ushort Read16BitOperand(Operand operand)
        {
            switch (operand)
            {
                ...
                case Operand.SPd:
                    return _alu.AddDisplacement(_registers.StackPointer, (sbyte) Operation.ByteLiteral);
                default:
                    throw new ArgumentOutOfRangeException(nameof(Operation.Operand2), Operation.Operand2, null);
            }
        }
