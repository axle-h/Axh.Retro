        ...
        private OpCode? DecodePrimary()
        {
            ...
            switch (code)
            {
                ...
                case PrimaryOpCode.LD_A_n:
                    ...
                    _operand1 = Operand.A;
                    _operand2 = Operand.n;
                    _opCodeMeta = OpCodeMeta.ByteLiteral;
                    return OpCode.Load;
                ...
                case PrimaryOpCode.LD_A_mHL:
                    _timer.Index(_index.IsDisplaced);
                    _operand1 = Operand.A;
                    _operand2 = _index.Index;
                    _opCodeMeta = OpCodeMeta.Displacement;
                    return OpCode.Load;
                ...
                case PrimaryOpCode.LD_mHL_n:
                    ...
                    _operand1 = _index.Index;
                    _operand2 = Operand.n;
                    _opCodeMeta = OpCodeMeta.Displacement | OpCodeMeta.ByteLiteral;
                    return OpCode.Load;
                ...
                case PrimaryOpCode.INC_mHL:
                    _timer.Index(_index.IsDisplaced).MmuByte().Extend(1);
                    _operand1 = _index.Index;
                    _opCodeMeta = OpCodeMeta.Displacement;
                    return OpCode.Increment;
                ...
                case PrimaryOpCode.JR:
                    ...
                    _operand1 = Operand.d;
                    _opCodeMeta = OpCodeMeta.ByteLiteral | OpCodeMeta.EndBlock;
