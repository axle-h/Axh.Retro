...
namespace Axh.Retro.GameBoy.Registers
{
    ...
    public class LcdStatusRegister : ILcdStatusRegister
    {
        ...
        /// </returns>
        public override string ToString() => $"GpuMode: {GpuMode}, CoincidenceInterrupt: {CoincidenceInterrupt}, Mode2OamInterrupt: {Mode2OamInterrupt}, Mode1VBlankInterrupt: {Mode1VBlankInterrupt}, Mode0HBlankInterrupt: {Mode0HBlankInterrupt}, CoincidenceFlag: {CoincidenceFlag}";
    }
}
