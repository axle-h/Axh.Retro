namespace Axh.Retro.CPU.X80.Tests.Core.Z80InstructionDecoder
{
    ...
    public class CompareTests : Z80InstructionDecoderTestsBase
    {
        ...
        public void CPD()
        {
            ...
            Run(4, 16, PrimaryOpCode.Prefix_ED, PrefixEdOpCode.CPD);
        ...
        public void CPDR_Match()
        {
            ...
            Run(4 + 5 * (queue.Length - 1), 16 + 21 * (queue.Length - 1), PrimaryOpCode.Prefix_ED, PrefixEdOpCode.CPDR);
        ...
        public void CPDR_NoMatch()
        {
            ...
            Run(4 + 5 * (Count - 1), 16 + 21 * (Count - 1), PrimaryOpCode.Prefix_ED, PrefixEdOpCode.CPDR);
