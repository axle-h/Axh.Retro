namespace Axh.Retro.CPU.X80.Tests.Core.Z80InstructionDecoder
{
    ...
    [TestFixture]
    public class ShiftTests : Z80InstructionDecoderTestsBase
    {
        ...
        public void SLA_r(PrefixCbOpCode opcode)
        {
            ...
            Run(2, 8, PrimaryOpCode.Prefix_CB, opcode);
        ...
        public void SLA_mHL()
        {
            ...
            Run(4, 15, PrimaryOpCode.Prefix_CB, PrefixCbOpCode.SLA_mHL);
        ...
        public void SLS_mHL()
        {
            ...
            Run(4, 15, PrimaryOpCode.Prefix_CB, PrefixCbOpCode.SLS_mHL);
        ...
        public void SRA_mHL()
        {
            ...
            Run(4, 15, PrimaryOpCode.Prefix_CB, PrefixCbOpCode.SRA_mHL);
        ...
        public void SRL_mHL()
        {
            ...
            Run(4, 15, PrimaryOpCode.Prefix_CB, PrefixCbOpCode.SRL_mHL);
        ...
        public void SLA_r_mIXYd(PrimaryOpCode prefix, PrefixCbOpCode opcode)
        {
            ...
            Run(8, 30, prefix, PrimaryOpCode.Prefix_CB, unchecked((byte)Displacement), opcode);
        ...
        public void SLA_mIXYd(PrimaryOpCode prefix)
        {
            ...
            Run(6, 23, prefix, PrimaryOpCode.Prefix_CB, unchecked((byte)Displacement), PrefixCbOpCode.SLA_mHL);
        ...
        public void SLS_mIXYd(PrimaryOpCode prefix)
        {
            ...
            Run(6, 23, prefix, PrimaryOpCode.Prefix_CB, unchecked((byte)Displacement), PrefixCbOpCode.SLS_mHL);
        ...
        public void SRA_mIXYd(PrimaryOpCode prefix)
        {
            ...
            Run(6, 23, prefix, PrimaryOpCode.Prefix_CB, unchecked((byte)Displacement), PrefixCbOpCode.SRA_mHL);
        ...
        public void SRL_mIXYd(PrimaryOpCode prefix)
        {
            ...
            Run(6, 23, prefix, PrimaryOpCode.Prefix_CB, unchecked((byte)Displacement), PrefixCbOpCode.SRL_mHL);
