namespace Axh.Retro.CPU.X80.Tests.Core.Z80InstructionDecoder
{
    ...
    public class RotateTests : Z80InstructionDecoderTestsBase
    {
        ...
        public void RLC_mHL()
        {
            ...
            Run(4, 15, PrimaryOpCode.Prefix_CB, PrefixCbOpCode.RLC_mHL);
        ...
        public void RL_mHL()
        {
            ...
            Run(4, 15, PrimaryOpCode.Prefix_CB, PrefixCbOpCode.RL_mHL);
        ...
        public void RLC_mIXYd(PrimaryOpCode prefix)
        {
            ...
            Run(6, 23, prefix, PrimaryOpCode.Prefix_CB, unchecked((byte)Displacement), PrefixCbOpCode.RLC_mHL);
        ...
        public void RL_mIXYd(PrimaryOpCode prefix)
        {
            ...
            Run(6, 23, prefix, PrimaryOpCode.Prefix_CB, unchecked((byte)Displacement), PrefixCbOpCode.RL_mHL);
        ...
        public void RRC_mHL()
        {
            ...
            Run(4, 15, PrimaryOpCode.Prefix_CB, PrefixCbOpCode.RRC_mHL);
        ...
        public void RR_mHL()
        {
            ...
            Run(4, 15, PrimaryOpCode.Prefix_CB, PrefixCbOpCode.RR_mHL);
        ...
        public void RRC_mIXYd(PrimaryOpCode prefix)
        {
            ...
            Run(6, 23, prefix, PrimaryOpCode.Prefix_CB, unchecked((byte)Displacement), PrefixCbOpCode.RRC_mHL);
        ...
        public void RR_mIXYd(PrimaryOpCode prefix)
        {
            ...
            Run(6, 23, prefix, PrimaryOpCode.Prefix_CB, unchecked((byte)Displacement), PrefixCbOpCode.RR_mHL);
