        ...
        private IEnumerable<Expression> TryDecodeNextDdFdCbPrefixOperation()
        {
            ...
            switch (opCode)
            {
                ...
                case PrefixCbOpCode.RLC_A:
                    yield return GetAluCallWrite(7, 27, DynaRecExpressions.AluRotateLeftWithCarry);
                ...
                case PrefixCbOpCode.RLC_mHL:
                    yield return GetAluCallWrite(5, 19, DynaRecExpressions.AluRotateLeftWithCarry);
                    break;

                // RL r (undocumented)
                // Actually RL (IX+d) & LD r,(IX+d) or RL (IY+d) & LD r,(IY+d)
                case PrefixCbOpCode.RL_A:
                    yield return GetAluCallWrite(7, 27, DynaRecExpressions.AluRotateLeft);
                    yield return Expression.Assign(DynaRecExpressions.A, index.ReadIndexedValue);
                    break;
                ...
                case PrefixCbOpCode.RL_mHL:
                    yield return GetAluCallWrite(5, 19, DynaRecExpressions.AluRotateLeft);
                    break;

                // RRC r (undocumented)
                // Actually RRC (IX+d) & LD r,(IX+d) or RRC (IY+d) & LD r,(IY+d)
                case PrefixCbOpCode.RRC_A:
                    yield return GetAluCallWrite(7, 27, DynaRecExpressions.AluRotateRightWithCarry);
                    yield return Expression.Assign(DynaRecExpressions.A, index.ReadIndexedValue);
                    break;
                ...
                case PrefixCbOpCode.RRC_mHL:
                    yield return GetAluCallWrite(5, 19, DynaRecExpressions.AluRotateRightWithCarry);
                    break;

                // RR r (undocumented)
                // Actually RR (IX+d) & LD r,(IX+d) or RR (IY+d) & LD r,(IY+d)
                case PrefixCbOpCode.RR_A:
                    yield return GetAluCallWrite(7, 27, DynaRecExpressions.AluRotateRight);
                    yield return Expression.Assign(DynaRecExpressions.A, index.ReadIndexedValue);
                    break;
                ...
                case PrefixCbOpCode.RR_mHL:
                    yield return GetAluCallWrite(5, 19, DynaRecExpressions.AluRotateRight);
                    break;
                ...
                case PrefixCbOpCode.SLA_A:
                    yield return GetAluCallWrite(7, 27, DynaRecExpressions.AluShiftLeft);
                    yield return Expression.Assign(DynaRecExpressions.A, index.ReadIndexedValue);
                    break;
                ...
                case PrefixCbOpCode.SLA_mHL:
                    yield return GetAluCallWrite(5, 19, DynaRecExpressions.AluShiftLeft);
                    break;

                // SLS r (undocumented)
                // Actually SLS (IX+d) & LD r,(IX+d) or SLS (IY+d) & LD r,(IY+d)
                case PrefixCbOpCode.SLS_A:
                    yield return GetAluCallWrite(7, 27, DynaRecExpressions.AluShiftLeftSet);
                    yield return Expression.Assign(DynaRecExpressions.A, index.ReadIndexedValue);
                    break;
                ...
                case PrefixCbOpCode.SLS_mHL:
                    yield return GetAluCallWrite(5, 19, DynaRecExpressions.AluShiftLeftSet);
                    break;

                // SRA r (undocumented)
                // Actually SRA (IX+d) & LD r,(IX+d) or SRA (IY+d) & LD r,(IY+d)
                case PrefixCbOpCode.SRA_A:
                    yield return GetAluCallWrite(7, 27, DynaRecExpressions.AluShiftRight);
                    yield return Expression.Assign(DynaRecExpressions.A, index.ReadIndexedValue);
                    break;
                ...
                case PrefixCbOpCode.SRA_mHL:
                    yield return GetAluCallWrite(5, 19, DynaRecExpressions.AluShiftRight);
                    break;

                // SRL r (undocumented)
                // Actually SRL (IX+d) & LD r,(IX+d) or SRL (IY+d) & LD r,(IY+d)
                case PrefixCbOpCode.SRL_A:
                    yield return GetAluCallWrite(7, 27, DynaRecExpressions.AluShiftRightLogical);
                    yield return Expression.Assign(DynaRecExpressions.A, index.ReadIndexedValue);
                    break;
                ...
                case PrefixCbOpCode.SRL_mHL:
                    yield return GetAluCallWrite(5, 19, DynaRecExpressions.AluShiftRightLogical);
                    break;
