namespace Axh.Emulation.CPU.X80.Tests.Registers
{
    ...
    using Axh.Emulation.CPU.X80.Registers;

    using Moq;
    using NUnit.Framework;

    using IGeneralPurposeRegisterSet = Axh.Emulation.CPU.X80.Contracts.Registers.IGeneralPurposeRegisterSet;
    using IZ80Registers = Axh.Emulation.CPU.X80.Contracts.Registers.IZ80Registers;
